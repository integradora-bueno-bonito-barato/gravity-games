    ...
    <div class="container-fluid  text-white fs-4 p-3">
        ...
        <div class="row align-items-center mt-5">
            ...
            <div class="col-md-4 p-4">
                <form class="bg-success p-4 rounded-3 " action="#">
                    ...
                    <input type="text" name="usuario" id="usuario" placeholder="Escribe tu nombre de usuario" class="form-control">
                    <label for="email">Email</label>
                    <input type="email" name="email" id="email" placeholder="Escribe tu email" class="form-control">
                    <label for="password">Contraseña</label>
                    <input type="password" name="password" id="password" placeholder="Escribe tu contraseña" class="form-control">
                    <label for="password2">Repite contraseña</label>
                    <input type="password" name="password2" id="password2" placeholder="Repite tu contraseña" class="form-control">
